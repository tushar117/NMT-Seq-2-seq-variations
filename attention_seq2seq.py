...
MODEL_NAME = 'attn-verse'
CACHE_DIR = "/home/tushar/Desktop/MS/sem 2/nlpa/assignment-2/saved_models/attention"
...
class Seq2seqModel(nn.Module):
    def __init__(self, encoder, decoder, device):
        ...
        self.attention = BahdanauAttention(2*encoder.hidden_dim, decoder.hidden_dim)
        self.device = device
    ...
    def forward(self, src_batch, trg_batch, src_field, teacher_verse=0.5):
        ...
        for i in range(1, trg_len):
            ...
            context_state, _ = self.attention(hidden, encoder_hidden_outputs, mask)
